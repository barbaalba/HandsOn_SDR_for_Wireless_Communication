...
class Signal_source(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Signal_source")
        ...
        self.exc_bw = exc_bw = 0.35
        self.sig_amp = sig_amp = 1
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(1.0,samp_rate,samp_rate/sps,exc_bw,11*sps)
        self.freq = freq = 2.41e9
        self.ant_gain = ant_gain = 0
        self.QAM = QAM = digital.constellation_rect([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        4, 2, 2, 1, 1).base()
        ...
        self._freq_range = qtgui.Range(2.4e9, 2.5e9, 0.01e9, 2.41e9, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "'freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_win)
        self._ant_gain_range = qtgui.Range(0, 10, 1, 0, 200)
        self._ant_gain_win = qtgui.RangeWidget(self._ant_gain_range, self.set_ant_gain, "'ant_gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ant_gain_win)
        ...
        self.uhd_usrp_sink_0.set_gain(ant_gain, 0)
        self._sig_amp_range = qtgui.Range(0, 10, 1, 1, 200)
        ...
        self.analog_random_source_x_2 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 1000))), True)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_random_source_x_2, 0), (self.blocks_throttle2_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_eye_sink_x_1, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(1.0,self.samp_rate,self.samp_rate/self.sps,self.exc_bw,11*self.sps))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(2.41e9, self.samp_rate)
    ...
    def get_ant_gain(self):
        return self.ant_gain

    def set_ant_gain(self, ant_gain):
        self.ant_gain = ant_gain
        self.uhd_usrp_sink_0.set_gain(self.ant_gain, 0)
