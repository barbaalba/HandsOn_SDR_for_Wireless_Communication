...
class QPSK_Tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Tx_gain_range = qtgui.Range(0, 20, 1, 10, 200)
        ...
        self.uhd_usrp_sink_0.set_center_freq(central_freq, 0)
        ...
        labels = ['Tx Real from scratch', 'Tx Imaginary from scratch', 'Tx real with mod block', 'Tx imaginary with mod block', 'Signal 5',
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0,2,1,2,3,2,1,3,2,3,1,0,2,3,1,0,2,1,2,2), True, 1, [])
    ...
    def set_central_freq(self, central_freq):
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.central_freq, 0)
