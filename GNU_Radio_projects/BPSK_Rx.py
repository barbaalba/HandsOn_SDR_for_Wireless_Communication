...
class PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_offset = freq_offset = -142e3
        self.central_freq = central_freq = 2.45e9

        ##################################################
        # Blocks
        ##################################################
        self._freq_offset_range = Range(-150e3, 0, 10, -142e3, 200)
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_c(
            1024*8, #size
            samp_rate, #samp_rate
            "Rx signal after CFO correction", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Spectrum of shifted signal", #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Spectrum of squared signal", #name
            1,
            None # parent
        )
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_0_0, 0))
