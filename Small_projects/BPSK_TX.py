...
class PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.central_freq = central_freq = 2.45e9

        ##################################################
        # Blocks
        ##################################################

        self._tx_gain_range = qtgui.Range(0, 10, 1, 0, 200)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0,1,0,1,0,0,0,1,1,0,0,1,1,1,1), True, 1, [])
